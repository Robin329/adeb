...
sudo qemu-debootstrap \
   --arch arm64 \
   --include=procps,git,clang-11,cmake,llvm-11-dev,libclang-11-dev,libelf-dev,libfl-dev,libunwind-dev,libdw-dev,git,libtool,autoconf,make,cmake,iperf,arping,ethtool,flex,bison,python,clang-7,python-netaddr,python-pyroute2 \
